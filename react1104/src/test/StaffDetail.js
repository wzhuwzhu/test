...
class StaffDetail extends Component {
  constructor(props) {
    super(props);
    this.state = {selectedId: null, selectedName: null, 
    		staffs: [], isLoading: true, showModal: false};
  ...
  async componentDidMount() {
    ...
    fetch('/api/staffs/find', {
        ...
        }, body: JSON.stringify(this.context.staffInput),})
      ...
      <div>
        ...
        <Container fluid>
          <div className="float-right">
            ...
            <Button color="success" tag={Link} to="/staffs/search">Advanced Staff Search</Button>
          </div>
