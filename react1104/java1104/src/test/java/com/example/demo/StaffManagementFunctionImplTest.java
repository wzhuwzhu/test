...
import com.springboot.demo.function.StaffManagementFunction;
import com.springboot.demo.mapper.*;

@Service
public class StaffManagementFunctionImplTest implements StaffManagementFunction{
	StaffManagementFunctionImplTest(){}
	@Override
	...
	public	StaffManagementViewObject updateStaff(StaffManagementArgumentObject staffManagementArgumentObject) throws Exception{
		...
		StaffManagementMapper smMapper = session.getMapper(StaffManagementMapper.class);
				...
				staff.setName(staffManagementArgumentObject.getName());
				staff.setGender(gender);
				staff.setDepartment(staffManagementArgumentObject.getDepartment());
				staff.setPosition(staffManagementArgumentObject.getPosition());
				staff.setPermission(staffManagementArgumentObject.getPermission());
	...
	public void deleteById(Long id) {
		...
		session.commit();
		System.out.println("Function.deleteById succeed!"+" "+id);
		MyBatisUtil.closeSession();
	}
	...
	public	List<StaffManagementViewObject> findStaffByKeys(StaffManagementArgumentObject staffManagementArgumentObject) throws Exception {
	    ...
	    public static void main(String[] args) throws Exception {
	    	//SqlSession session = MyBatisUtil.getSession();
			//StaffManagementMapper smMapper = session.getMapper(StaffManagementMapper.class);
	    	StaffManagementFunctionImplTest function = new StaffManagementFunctionImplTest();
	    	
	    	
	    	StaffManagementArgumentObject staffAO1 = new StaffManagementArgumentObject();
	    	staffAO1.setPhoneNo("15");
	    	staffAO1.setEnrolledSince("200");
	    	//function.addStaff(staffAO1); 	
	    	
	    	List<StaffManagementViewObject> staffVOList1 = function.findStaffByKeys(staffAO1);
	    	System.out.println("function.findStaffByKeys succeed!" + staffVOList1);
